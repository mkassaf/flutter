...
class _LoginPageState extends State<SignUpPage> {
  ...
  Future<bool> registerFireBase(
    ...
    // This is a placeholder for the actual Firebase registration logic
    try {
      ...
      if (e.code == 'weak-password') {
        showErrorMessage('Weak Password', 'The password provided is too weak.');
        ...
        showErrorMessage('Registration Failed', e.message ?? 'Unknown error');
      }
      return false;
    }
  }
